...
//jQuery Floating Social Share Buttons
    ...
    $.extend(Plugin.prototype, {
        init: function() {
            ...
            $.each(this.settings.buttons, function(index, value) {
                ...
                !0 === base.settings.target && $component.attr("target", "_blank").attr("rel", "nofollow noopener noreferrer"), !0 === base.settings.counter && setShareCount(value, encodeURI(base.settings.url), $component, base.settings.twitter_counter), $child.append($component)
...
// Tocbot for generating Table of Contents on fly
...
// Init Floating Social Share
$("body").floatingSocialShare({
  buttons: ["facebook", "twitter", "google-plus", "reddit", "pinterest"],
  text: "share with:"
});
